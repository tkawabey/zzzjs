...
ZZZJS_BEGIN_GET_PROP(wxLogChain, LogChain)
	switch (id) 
	{
	case P_OLD_LOG:
		{
...
ZZZJS_BEGIN_SET_PROP(wxLogChain, LogChain)

    return true;
ZZZJS_END_SET_PROP	
	
ZZZJS_BEGIN_GET_SET_STR_PROP(wxLogChain, LogChain)
	Log::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
ZZZJS_END_GET_SET_STR_PROP
	
ZZZJS_BEGIN_ADD_PROP(wxLogChain, LogChain)
...
ZZZJS_BEGIN_DEL_PROP(wxLogChain, LogChain)
...
// コンストラクタ
ZZZJS_BEGIN_CONSTRUCTOR(wxLogChain, LogChain)
...
// デストラクタ
ZZZJS_BEGIN_DESTRUCTOR(wxLogChain, LogChain)
