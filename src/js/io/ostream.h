...
namespace zzzJs
{
    namespace io
    {
        class OutputStream : public JsWrapper<OutputStream, Stream>
        {
        public:
            ...
            static JSBool putC(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool write(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool seekO(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool sync(JSContext *cx, unsigned argc, JS::Value *vp);
        };
    }; // namespace io
}; // namespace wxjs
