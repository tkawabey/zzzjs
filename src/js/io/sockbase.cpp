 ...
 * </class>
 */
WXJS_INIT_CLASS(SocketBase, "SocketBase", 0)
 ...
 *  </property>
 *  <property name="lastCount" type=WXJS_TYPE_NUMBER readonly="Y">
...
//bool SocketBase::GetProperty(SocketBasePrivate *p,  
//                                  JSContext *cx, 
//                                  JSObject *obj, 
//                                  int id, 
//                                  JS::MutableHandle<JS::Value>& vp)
//{
WXJS_BEGIN_GET_PROP(SocketBasePrivate, SocketBase)
	switch(id)
	{
	case P_CONNECTED:
		ToJSVal(cx, vp, p->GetBase()->IsConnected());
		break;
	case P_DATA:
		ToJSVal(cx, vp, p->GetBase()->IsData());
		break;
	case P_DISCONNECTED:
		ToJSVal(cx, vp, p->GetBase()->IsDisconnected());
		break;
	case P_ERROR:
		ToJSVal(cx, vp, p->GetBase()->Error());
		break;
	case P_LASTCOUNT:
		{
 ...
 * </method>
 */
JSBool SocketBase::close(JSContext *cx, unsigned argc, JS::Value *vp)
{
 ...
 * </method>
 */
JSBool SocketBase::discard(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::interruptWait(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::notify(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::peek(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::read(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::readMsg(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::unread(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::restoreState(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::saveState(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *  <function>
 *   <arg name="Seconds" type=WXJS_TYPE_NUMBER /> 
 *  </function>
 *  <desc>
 ...
 * </method>
 */
JSBool SocketBase::setTimeout(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *   <arg name="Seconds" type=WXJS_TYPE_NUMBER default="-1" /> 
 *   <arg name="MilliSeconds" type=WXJS_TYPE_NUMBER default="0" /> 
 *  </function>
 *  <desc>
 ...
 * </method>
 */
JSBool SocketBase::wait(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
	...
	case 1:
		...
		// Fall through
	default:
		*vp = ToJS(cx, p->GetBase()->Wait(secs, ms));
	}
	return JS_TRUE;	
}
 ...
 * </method>
 */
JSBool SocketBase::waitForLost(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
	...
	case 1:
		...
		// Fall through
	default:
		*vp = ToJS(cx, p->GetBase()->WaitForLost(secs, ms));
	}
	return JS_TRUE;	
}
 ...
 * </method>
 */
JSBool SocketBase::waitForRead(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
	...
	case 1:
		...
		// Fall through
	default:
		*vp = ToJS(cx, p->GetBase()->WaitForRead(secs, ms));
	}
	return JS_TRUE;	
}
 ...
 * </method>
 */
JSBool SocketBase::waitForWrite(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
	...
	case 1:
		...
		// Fall through
	default:
		*vp = ToJS(cx, p->GetBase()->WaitForWrite(secs, ms));
	}
	return JS_TRUE;	
}
 ...
 * </method>
 */
JSBool SocketBase::write(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool SocketBase::writeMsg(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
