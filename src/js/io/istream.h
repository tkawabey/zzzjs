...
namespace zzzJs
{
    namespace io
    {
        class InputStream : public JsWrapper<InputStream, Stream>
        {
        public:
            /**
             ...
             */
            //static bool SetProperty(Stream *p, 
            //                      JSContext *cx, 
            //                      JSObject *obj, 
            //                      int id, 
            //                      JS::MutableHandle<JS::Value>& vp);
			ZZZJS_DECLARE_SET_PROP(Stream)
            ...
            static JSBool getC(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool peek(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool read(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool seekI(JSContext *cx, unsigned argc, JS::Value *vp);
            static JSBool ungetch(JSContext *cx, unsigned argc, JS::Value *vp);
        };
    }; // namespace io
}; // namespace wxjs
