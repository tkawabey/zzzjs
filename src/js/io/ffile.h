...
namespace zzzJs
{
    namespace io
    {
        class FFile : public JsWrapper<FFile, wxFFile>
        {
        public:
        	
	        //static bool GetProperty(wxFFile *f, 
         //                         JSContext *cx, 
         //                         JSObject *obj, 
         //                         int id, 
         //                         JS::MutableHandle<JS::Value>& vp);
			ZZZJS_DECLARE_GET_PROP(wxFFile)
	        ...
	        //static wxFFile *Construct(JSContext *cx, 
									//	unsigned int argc, 
									//	JS::Value *vp, 
									//	bool constructing);
			ZZZJS_DECLARE_CONSTRUCTOR(wxFFile)
	        ...
	        static JSBool readAll(JSContext *cx, unsigned argc, JS::Value *vp);
