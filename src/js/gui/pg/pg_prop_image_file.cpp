...
//	ImageFileProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(ImageFileProperty, "ImageFileProperty", 0)
	

WXJS_BEGIN_DESTRUCTOR(wxImageFileProperty, ImageFileProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxImageFileProperty, ImageFileProperty)
	...
	wxImageFileProperty *p = new wxImageFileProperty(label, name, value);
	SetPrivate(cx, obj, p);
	return p;
...
WXJS_BEGIN_GET_SET_STR_PROP(wxImageFileProperty, ImageFileProperty)
	FileProperty::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
