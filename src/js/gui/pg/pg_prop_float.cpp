...
//	FloatProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(FloatProperty, "FloatProperty", 1)
	

WXJS_BEGIN_DESTRUCTOR(wxFloatProperty, FloatProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxFloatProperty, FloatProperty)
...
WXJS_BEGIN_GET_SET_STR_PROP(wxFloatProperty, FloatProperty)
