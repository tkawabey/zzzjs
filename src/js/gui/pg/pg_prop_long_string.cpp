...
//	LongStringProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(LongStringProperty, "LongStringProperty", 0)
	

WXJS_BEGIN_DESTRUCTOR(wxLongStringProperty, LongStringProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxLongStringProperty, LongStringProperty)
	...
	wxLongStringProperty *p = new wxLongStringProperty(label, name, value);
	SetPrivate(cx, obj, p);
	return p;
...
WXJS_BEGIN_GET_SET_STR_PROP(wxLongStringProperty, LongStringProperty)
