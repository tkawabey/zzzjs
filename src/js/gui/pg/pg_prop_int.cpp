...
//	IntProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(IntProperty, "IntProperty", 1)
	

WXJS_BEGIN_DESTRUCTOR(wxIntProperty, IntProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxIntProperty, IntProperty)
...
WXJS_BEGIN_GET_SET_STR_PROP(wxIntProperty, IntProperty)
