...
//	StringProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(StringProperty, "StringProperty", 0)
	

WXJS_BEGIN_DESTRUCTOR(wxStringProperty, StringProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxStringProperty, StringProperty)
...
WXJS_BEGIN_GET_SET_STR_PROP(wxStringProperty, StringProperty)
