...
//	ArrayStringProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(ArrayStringProperty, "ArrayStringProperty", 1)
	

WXJS_BEGIN_DESTRUCTOR(wxArrayStringProperty, ArrayStringProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxArrayStringProperty, ArrayStringProperty)
	...
	case 3:
		if( FromJS(cx, argv[2], value) == false ) {
			JS_ReportError(cx, WXJS_INVALID_ARG_TYPE, 3, "ArrayString");
			return JS_FALSE;
		}
	case 2:
	...
	wxArrayStringProperty *p = new wxArrayStringProperty(label, name, value);
	SetPrivate(cx, obj, p);
	return p;
...
WXJS_BEGIN_GET_SET_STR_PROP(wxArrayStringProperty, ArrayStringProperty)
