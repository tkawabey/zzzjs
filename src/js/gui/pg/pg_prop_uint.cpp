...
//	UIntProperty
//--------------------------------------------------------
WXJS_INIT_CLASS(UIntProperty, "UIntProperty", 0)
	

WXJS_BEGIN_DESTRUCTOR(wxUIntProperty, UIntProperty)

WXJS_END_DESTRUCTOR

WXJS_BEGIN_CONSTRUCTOR(wxUIntProperty, UIntProperty)
	...
	wxUIntProperty *p = new wxUIntProperty(label, name, value);
	SetPrivate(cx, obj, p);
	return p;
...
WXJS_BEGIN_GET_SET_STR_PROP(wxUIntProperty, UIntProperty)
