...
//--------------------------------------------------------
WXJS_INIT_CLASS(DataViewProgressRenderer, "DataViewProgressRenderer", 0)



WXJS_BEGIN_GET_SET_STR_PROP(wxDataViewProgressRenderer, DataViewProgressRenderer)
	DataViewRenderer::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
ZZZJS_END_GET_SET_STR_PROP

WXJS_BEGIN_CONSTRUCTOR(wxDataViewProgressRenderer, DataViewProgressRenderer)
	JS::CallArgs argv = CallArgsFromVp(argc, vp);

	wxString				label = wxEmptyString;
	wxString				varianttype = wxDataViewProgressRenderer::GetDefaultType();
	...
	case 3:
		...
		break;
	case 2:
		if ( ! FromJS(cx, argv[1], varianttype) )
		{
	...
	wxDataViewProgressRenderer *p = new wxDataViewProgressRenderer(label, varianttype, (wxDataViewCellMode)mode, align);
	
	return p;
WXJS_END_CONSTRUCTOR

	
WXJS_BEGIN_DESTRUCTOR(wxDataViewProgressRenderer, DataViewProgressRenderer)
