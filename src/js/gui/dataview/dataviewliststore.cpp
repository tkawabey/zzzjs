...
//	MyDataViewListStore
//--------------------------------------------------------
MyDataViewListStore::MyDataViewListStore(JSContext *cx, JSObject* pObj)
	:	wxDataViewListStore()
	,	m_pCx(cx)
	,	m_pObj( pObj )
{
...
unsigned int MyDataViewListStore::GetColumnCount() const
{
	jsval fval;
...
wxString MyDataViewListStore::GetColumnType( unsigned int col ) const
{
	jsval fval;
...
void MyDataViewListStore::GetValueByRow( wxVariant &variant,
...
bool MyDataViewListStore::GetAttrByRow( unsigned int row, unsigned int col,
...
bool MyDataViewListStore::SetValueByRow( const wxVariant &variant,
...
//	DataViewListStore
//--------------------------------------------------------
WXJS_INIT_CLASS(DataViewListStore, "DataViewListStore", 1)

void DataViewListStore::InitClass(JSContext* cx, 
									JSObject* obj, 
									JSObject* proto)
{
...
//WXJS_BEGIN_CONSTANT_MAP(DataViewListStore)
 ...
 * </properties>
 */
WXJS_BEGIN_PROPERTY_MAP(DataViewListStore)
  WXJS_PROPERTY(P_ColumnCount, "columnCount")
WXJS_END_PROPERTY_MAP()

WXJS_BEGIN_GET_PROP(MyDataViewListStore, DataViewListStore)
	switch (id) 
	{
	case P_ColumnCount:
...
WXJS_BEGIN_SET_PROP(MyDataViewListStore, DataViewListStore)
	switch (id) 
	{
	case P_FLAG:
		{
...
WXJS_BEGIN_ADD_PROP(MyDataViewListStore, DataViewListStore)
	return true;
WXJS_END_ADD_PROP
	
WXJS_BEGIN_DEL_PROP(MyDataViewListStore, DataViewListStore)
  return true;
WXJS_END_DEL_PROP
 ...
 *  </function>
 *  <desc>
 *   Constructs a new MyDataViewListStore object.
 *  </desc>
 * </ctor>
 */
WXJS_BEGIN_CONSTRUCTOR(MyDataViewListStore, DataViewListStore)
	MyDataViewListStore *p = new MyDataViewListStore(cx, obj);
	return p;
WXJS_END_CONSTRUCTOR


WXJS_BEGIN_DESTRUCTOR(MyDataViewListStore, DataViewListStore)

WXJS_END_DESTRUCTOR


WXJS_BEGIN_METHOD_MAP(DataViewListStore)
...
JSBool DataViewListStore::getItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
		
    wxDataViewListStore *p = GetPrivate(cx, obj);
	if( p == NULL ) {
		return JS_FALSE;
	}
	unsigned int row = 0;
...
JSBool DataViewListStore::reset(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowAppended(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowChanged(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowDeleted(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowInserted(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowPrepended(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowValueChanged(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewListStore::rowsDeleted(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
