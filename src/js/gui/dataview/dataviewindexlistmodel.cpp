...
//--------------------------------------------------------
//	MyDataViewIndexListModel
//--------------------------------------------------------
MyDataViewIndexListModel::MyDataViewIndexListModel(JSContext *cx, JSObject* pObj, unsigned int initial_size /*= 0 */)
...
unsigned int MyDataViewIndexListModel::GetColumnCount() const
{
	jsval fval;
...
wxString MyDataViewIndexListModel::GetColumnType( unsigned int col ) const
{
	jsval fval;
...
void MyDataViewIndexListModel::GetValueByRow( wxVariant &variant,
...
bool MyDataViewIndexListModel::GetAttrByRow( unsigned int row, unsigned int col,
...
bool MyDataViewIndexListModel::SetValueByRow( const wxVariant &variant,
...
//--------------------------------------------------------
WXJS_INIT_CLASS(DataViewIndexListModel, "DataViewIndexListModel", 1)

void DataViewIndexListModel::InitClass(JSContext* cx, 
									JSObject* obj, 
									JSObject* proto)
{
...
//WXJS_BEGIN_CONSTANT_MAP(DataViewIndexListModel)
 ...
 * </properties>
 */
WXJS_BEGIN_PROPERTY_MAP(DataViewIndexListModel)
  WXJS_PROPERTY(P_ColumnCount, "columnCount")
WXJS_END_PROPERTY_MAP()

WXJS_BEGIN_GET_PROP(MyDataViewIndexListModel, DataViewIndexListModel)
	switch (id) 
	{
	case P_ColumnCount:
...
WXJS_BEGIN_SET_PROP(MyDataViewIndexListModel, DataViewIndexListModel)
	switch (id) 
	{
	case P_FLAG:
		{
...
WXJS_BEGIN_ADD_PROP(MyDataViewIndexListModel, DataViewIndexListModel)
	return true;
WXJS_END_ADD_PROP
	
WXJS_BEGIN_DEL_PROP(MyDataViewIndexListModel, DataViewIndexListModel)
  return true;
WXJS_END_DEL_PROP
 ...
 *  </function>
 *  <desc>
 *   Constructs a new MyDataViewIndexListModel object.
 *  </desc>
 * </ctor>
 */
WXJS_BEGIN_CONSTRUCTOR(MyDataViewIndexListModel, DataViewIndexListModel)
	...
	MyDataViewIndexListModel *p = new MyDataViewIndexListModel(cx, obj, initial_size);
	return p;
WXJS_END_CONSTRUCTOR


WXJS_BEGIN_DESTRUCTOR(MyDataViewIndexListModel, DataViewIndexListModel)

WXJS_END_DESTRUCTOR


WXJS_BEGIN_METHOD_MAP(DataViewIndexListModel)
...
JSBool DataViewIndexListModel::getItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
		
    wxDataViewIndexListModel *p = GetPrivate(cx, obj);
	if( p == NULL ) {
		return JS_FALSE;
	}
	unsigned int row = 0;
...
JSBool DataViewIndexListModel::reset(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowAppended(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowChanged(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowDeleted(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowInserted(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowPrepended(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowValueChanged(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool DataViewIndexListModel::rowsDeleted(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
