...
//--------------------------------------------------------
WXJS_INIT_CLASS(DataViewDateRenderer, "DataViewDateRenderer", 0)



WXJS_BEGIN_GET_SET_STR_PROP(wxDataViewDateRenderer, DataViewDateRenderer)
	DataViewRenderer::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
ZZZJS_END_GET_SET_STR_PROP

WXJS_BEGIN_CONSTRUCTOR(wxDataViewDateRenderer, DataViewDateRenderer)
	JS::CallArgs argv = CallArgsFromVp(argc, vp);

	wxString				varianttype = wxDataViewDateRenderer::GetDefaultType();
	...
	wxDataViewDateRenderer *p = new wxDataViewDateRenderer(varianttype, (wxDataViewCellMode)mode, align);
	
	return p;
WXJS_END_CONSTRUCTOR

	
WXJS_BEGIN_DESTRUCTOR(wxDataViewDateRenderer, DataViewDateRenderer)
