...
//--------------------------------------------------------
WXJS_INIT_CLASS(DataViewToggleRenderer, "DataViewToggleRenderer", 0)



WXJS_BEGIN_GET_SET_STR_PROP(wxDataViewToggleRenderer, DataViewToggleRenderer)
	DataViewRenderer::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
ZZZJS_END_GET_SET_STR_PROP

WXJS_BEGIN_CONSTRUCTOR(wxDataViewToggleRenderer, DataViewToggleRenderer)
	JS::CallArgs argv = CallArgsFromVp(argc, vp);

	wxString				varianttype = wxDataViewToggleRenderer::GetDefaultType();
	...
	wxDataViewToggleRenderer *p = new wxDataViewToggleRenderer(varianttype, (wxDataViewCellMode)mode, align);
	
	return p;
WXJS_END_CONSTRUCTOR

	
WXJS_BEGIN_DESTRUCTOR(wxDataViewToggleRenderer, DataViewToggleRenderer)
