...
//--------------------------------------------------------
WXJS_INIT_CLASS(DataViewTextRenderer, "DataViewTextRenderer", 0)



WXJS_BEGIN_GET_SET_STR_PROP(wxDataViewTextRenderer, DataViewTextRenderer)
	DataViewRenderer::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
ZZZJS_END_GET_SET_STR_PROP

WXJS_BEGIN_CONSTRUCTOR(wxDataViewTextRenderer, DataViewTextRenderer)
	JS::CallArgs argv = CallArgsFromVp(argc, vp);

	wxString				varianttype = wxDataViewTextRenderer::GetDefaultType();
	...
	wxDataViewTextRenderer *p = new wxDataViewTextRenderer(varianttype, (wxDataViewCellMode)mode, align);
	
	return p;
WXJS_END_CONSTRUCTOR

	
WXJS_BEGIN_DESTRUCTOR(wxDataViewTextRenderer, DataViewTextRenderer)
