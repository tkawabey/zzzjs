 ...
 * USA.
 *
 * $Id: client_dc.cpp 810 2007-07-13 20:07:05Z fbraem $
 */
...
WXJS_INIT_CLASS(ClientDC, "ClientDC", 1)

	


WXJS_BEGIN_GET_SET_STR_PROP(wxClientDC, ClientDC)
	WindowDC::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
 ...
 *  </function>
 *  <desc>
 *   Constructs a new wxClientDC object.
 *  </desc>
 * </ctor>
 */
WXJS_BEGIN_CONSTRUCTOR(wxClientDC, ClientDC)
{
