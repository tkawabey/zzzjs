 ...
 * </class>
 */
WXJS_INIT_CLASS(SplitterEvent, "SplitterEvent", 0)
                                  ...
                                  JS::MutableHandle<JS::Value>& vp)
{
    ...
    case P_SASH_POSITION:
	  {
		  vp.setInt32( event->GetSashPosition() );
         break;
	  }
    case P_X:
	  {
		  vp.setInt32( event->GetX() );
         break;
	  }
    case P_Y:
	  {
		  vp.setInt32(  event->GetY() );
         break;
	  }
...
WXJS_BEGIN_GET_SET_STR_PROP(PrivSplitterEvent, SplitterEvent)
