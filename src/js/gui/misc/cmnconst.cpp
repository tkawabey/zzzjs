...
{
    ZZZJS_CONSTANT(wxTreeItemIcon_, Normal)
    ZZZJS_CONSTANT(wxTreeItemIcon_, Selected)        
    ZZZJS_CONSTANT(wxTreeItemIcon_, Expanded)        
    ZZZJS_CONSTANT(wxTreeItemIcon_, SelectedExpanded)
	{ 0 }
};

void InitCommonConst(JSContext *cx, JSObject *obj)
{
    JSObject *constObj = JS_DefineObject(cx, obj, "TreeItemIcon", 
							   NULL, NULL,
