...
JSConstDoubleSpec wxGlobalMapMisc[] = 
{
...
JSConstDoubleSpec wxFontFamilyMap[] = 
{
	WXJS_CONSTANT(wxFONTFAMILY_,DEFAULT)
	WXJS_CONSTANT(wxFONTFAMILY_,DECORATIVE)
	WXJS_CONSTANT(wxFONTFAMILY_,ROMAN)
	WXJS_CONSTANT(wxFONTFAMILY_,SCRIPT)
	WXJS_CONSTANT(wxFONTFAMILY_,SWISS)
	WXJS_CONSTANT(wxFONTFAMILY_,MODERN)
	WXJS_CONSTANT(wxFONTFAMILY_,TELETYPE)
	WXJS_CONSTANT(wxFONTFAMILY_,MAX)
	WXJS_CONSTANT(wxFONTFAMILY_,UNKNOWN)
	{ 0 }
};
JSConstDoubleSpec wxFontStyleMap[] = 
{
	WXJS_CONSTANT(wxFONTSTYLE_,NORMAL)
	WXJS_CONSTANT(wxFONTSTYLE_,ITALIC)
	WXJS_CONSTANT(wxFONTSTYLE_,SLANT)
	WXJS_CONSTANT(wxFONTSTYLE_,MAX)
	{ 0 }
};
JSConstDoubleSpec wxFontWeightMap[] = 
{
	WXJS_CONSTANT(wxFONTWEIGHT_,NORMAL)
	WXJS_CONSTANT(wxFONTWEIGHT_,LIGHT)
	WXJS_CONSTANT(wxFONTWEIGHT_,BOLD)
	WXJS_CONSTANT(wxFONTWEIGHT_,MAX)
	{ 0 }
};
JSConstDoubleSpec wxFontSymbolicSizeMap[] = 
{
	WXJS_CONSTANT(wxFONTSIZE_,XX_SMALL)
	WXJS_CONSTANT(wxFONTSIZE_,X_SMALL)
	WXJS_CONSTANT(wxFONTSIZE_,SMALL)
	WXJS_CONSTANT(wxFONTSIZE_,MEDIUM)
	WXJS_CONSTANT(wxFONTSIZE_,LARGE)
	WXJS_CONSTANT(wxFONTSIZE_,X_LARGE)
	WXJS_CONSTANT(wxFONTSIZE_,XX_LARGE)
	{ 0 }
};
JSConstDoubleSpec wxFontFlagMap[] = 
{
	WXJS_CONSTANT(wxFONTFLAG_,DEFAULT)
	WXJS_CONSTANT(wxFONTFLAG_,ITALIC)
	WXJS_CONSTANT(wxFONTFLAG_,SLANT)
	WXJS_CONSTANT(wxFONTFLAG_,LIGHT)
	WXJS_CONSTANT(wxFONTFLAG_,BOLD)
	WXJS_CONSTANT(wxFONTFLAG_,ANTIALIASED)
	WXJS_CONSTANT(wxFONTFLAG_,NOT_ANTIALIASED)
	WXJS_CONSTANT(wxFONTFLAG_,UNDERLINED)
	WXJS_CONSTANT(wxFONTFLAG_,STRIKETHROUGH)
	WXJS_CONSTANT(wxFONTFLAG_,MASK)
	{ 0 }
};

JSConstDoubleSpec wxRasterOperationModeMap[] = 
{
	WXJS_CONSTANT(wx,CLEAR)
	WXJS_CONSTANT(wx,XOR)
	WXJS_CONSTANT(wx,INVERT)
	WXJS_CONSTANT(wx,OR_REVERSE)
	WXJS_CONSTANT(wx,AND_REVERSE)
	WXJS_CONSTANT(wx,COPY)
	WXJS_CONSTANT(wx,AND)
	WXJS_CONSTANT(wx,AND_INVERT)
	WXJS_CONSTANT(wx,NO_OP)
	WXJS_CONSTANT(wx,NOR)
	WXJS_CONSTANT(wx,EQUIV)
	WXJS_CONSTANT(wx,SRC_INVERT)
	WXJS_CONSTANT(wx,OR_INVERT)
	WXJS_CONSTANT(wx,NAND)
	WXJS_CONSTANT(wx,OR)
	WXJS_CONSTANT(wx,SET)
#if WXWIN_COMPATIBILITY_2_8
	WXJS_CONSTANT(wx,ROP_BLACK)
	WXJS_CONSTANT(wx,BLIT_BLACKNESS)
	WXJS_CONSTANT(wx,ROP_XORPEN)
	WXJS_CONSTANT(wx,BLIT_SRCINVERT)
	WXJS_CONSTANT(wx,ROP_NOT)
	WXJS_CONSTANT(wx,BLIT_DSTINVERT)
	WXJS_CONSTANT(wx,ROP_MERGEPENNOT)
	WXJS_CONSTANT(wx,BLIT_00DD0228)
	WXJS_CONSTANT(wx,ROP_MASKPENNOT)
	WXJS_CONSTANT(wx,BLIT_SRCERASE)
	WXJS_CONSTANT(wx,ROP_COPYPEN)
	WXJS_CONSTANT(wx,BLIT_SRCCOPY)
	WXJS_CONSTANT(wx,ROP_MASKPEN)
	WXJS_CONSTANT(wx,BLIT_SRCAND)
	WXJS_CONSTANT(wx,ROP_MASKNOTPEN)
	WXJS_CONSTANT(wx,BLIT_00220326)
	WXJS_CONSTANT(wx,ROP_NOP)
	WXJS_CONSTANT(wx,BLIT_00AA0029)
	WXJS_CONSTANT(wx,ROP_NOTMERGEPEN)
	WXJS_CONSTANT(wx,BLIT_NOTSRCERASE)
	WXJS_CONSTANT(wx,ROP_NOTXORPEN)
	WXJS_CONSTANT(wx,BLIT_00990066)
	WXJS_CONSTANT(wx,ROP_NOTCOPYPEN)
	WXJS_CONSTANT(wx,BLIT_NOTSCRCOPY)
	WXJS_CONSTANT(wx,ROP_MERGENOTPEN)
	WXJS_CONSTANT(wx,BLIT_MERGEPAINT)
	WXJS_CONSTANT(wx,ROP_NOTMASKPEN)
	WXJS_CONSTANT(wx,BLIT_007700E6)
	WXJS_CONSTANT(wx,ROP_MERGEPEN)
	WXJS_CONSTANT(wx,BLIT_SRCPAINT)
	WXJS_CONSTANT(wx,ROP_WHITE)
	WXJS_CONSTANT(wx,BLIT_WHITENESS)
#endif /*WXWIN_COMPATIBILITY_2_8*/
	{ 0 }
};
JSConstDoubleSpec wxRegionContainMap[] = 
{
	WXJS_CONSTANT(wx,OutRegion)
	WXJS_CONSTANT(wx,PartRegion)
	WXJS_CONSTANT(wx,InRegion)
	{ 0 }
};
JSConstDoubleSpec wxRegionOpMap[] = 
{
	WXJS_CONSTANT(wxRGN_,AND)
	WXJS_CONSTANT(wxRGN_,COPY)
	WXJS_CONSTANT(wxRGN_,DIFF)
	WXJS_CONSTANT(wxRGN_,OR)
	WXJS_CONSTANT(wxRGN_,XOR)
	{ 0 }
};
...
void zzzJs::gui::InitGuiConstants(JSContext *cx, JSObject *obj)
{
	// Define the global constants


	JS_DefineConstDoubles(cx, obj, wxGlobalMapMisc);

	// Create all the separate constant objects.

	JSObject *constObj = JS_DefineObject(cx, obj, "Direction", 
										 NULL, NULL,
										 JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxDirectionMap);

	constObj = JS_DefineObject(cx, obj, "Stretch", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxStretchMap);

	constObj = JS_DefineObject(cx, obj, "Orientation", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxOrientationMap);

	constObj = JS_DefineObject(cx, obj, "Alignment", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxAlignmentMap);

	constObj = JS_DefineObject(cx, obj, "Id", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxIdMap);

	constObj = JS_DefineObject(cx, obj, "KeyCode", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxKeyCodeMap);

	constObj = JS_DefineObject(cx, obj, "CalendarDateBorder", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxCalendarDateBorderMap);

	constObj = JS_DefineObject(cx, obj, "FontEncoding", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxCalendarDateBorderMap);

	constObj = JS_DefineObject(cx, obj, "BitmapType", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxBitmapTypeMap);

    constObj = JS_DefineObject(cx, obj, "Filter", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);

	JS_DefineConstDoubles(cx, constObj, wxFilterMap);

    constObj = JS_DefineObject(cx, obj, "ItemKind", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxItemKindMap);

    constObj = JS_DefineObject(cx, obj, "Border", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxBorderMap);


    constObj = JS_DefineObject(cx, obj, "FontFamily", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxFontFamilyMap);


    constObj = JS_DefineObject(cx, obj, "FontStyle", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxFontStyleMap);


    constObj = JS_DefineObject(cx, obj, "FontWeight", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxFontWeightMap);


    constObj = JS_DefineObject(cx, obj, "FontSymbolicSize", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxFontSymbolicSizeMap);
    ...
    constObj = JS_DefineObject(cx, obj, "FontFlag", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxFontFlagMap);


    constObj = JS_DefineObject(cx, obj, "RasterOperationMode", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxRasterOperationModeMap);


    constObj = JS_DefineObject(cx, obj, "RegionContain", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxRegionContainMap);


    constObj = JS_DefineObject(cx, obj, "RegionOp", 
										NULL, NULL,
										JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineConstDoubles(cx, constObj, wxRegionOpMap);
}
