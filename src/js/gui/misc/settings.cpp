 ...
 * </class>
 */
WXJS_INIT_CLASS(SystemSettings, "SystemSettings", 0)
...
/***
 * <class_properties>
 *  <property name="screenType" type=WXJS_TYPE_NUMBER>
 *   Get/Set the screen type.
 *  </property>
 * </class_properties>
 */
bool SystemSettings::GetStaticProperty(JSContext *cx, int id, JS::MutableHandle<JS::Value>& vp)
{
	switch ( id )
	{
	case P_SCREEN_TYPE:
		ToJSVal(cx, vp, static_cast<int>(wxSystemSettings::GetScreenType()));
		break;
	}
	return true;
}

bool SystemSettings::SetStaticProperty(JSContext *cx, int id, JS::MutableHandle<JS::Value>& vp)
{
	switch ( id )
	{
	case P_SCREEN_TYPE:
 ...
 * </class_method>
 */
JSBool SystemSettings::getColour(JSContext *cx, unsigned argc, JS::Value *vp)
{
	...
	*vp = Colour::CreateObject(cx, new wxColour(colour));
	return JS_TRUE;
}
 ...
 * </class_method>
 */
JSBool SystemSettings::getFont(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </class_method>
 */
JSBool SystemSettings::getMetric(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
...
JSBool SystemSettings::hasFeature(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
