 ...
 * </class>
 */
ZZZJS_INIT_CLASS(JPEGHandler, "JPEGHandler", 0)

//ImageHandlerPrivate* JPEGHandler::Construct(JSContext *cx, 
//										unsigned int argc, 
//										JS::Value *vp, 
//										bool constructing)
//{
ZZZJS_BEGIN_CONSTRUCTOR(ImageHandlerPrivate, JPEGHandler)
{
