...
namespace zzzJs
{
    namespace gui
    {
         ...
         */
        JSBool MessageBox(JSContext *cx, unsigned argc, JS::Value *vp);
        JSBool InitAllImageHandlers(JSContext *cx, unsigned argc, JS::Value *vp);
        JSBool NewID(JSContext *cx, unsigned argc, JS::Value *vp);
