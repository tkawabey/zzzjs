    ...
    namespace gui
    {
      ...
      public:
        static void InitClass(JSContext* cx, 
			...
			WXJS_DECLARE_ADD_PROP(wxFindReplaceDialog)
			WXJS_DECLARE_DEL_PROP(wxFindReplaceDialog)
			WXJS_DECLARE_GET_PROP(wxFindReplaceDialog)
			WXJS_DECLARE_SET_STR_PROP(wxFindReplaceDialog)
			WXJS_DECLARE_CONSTRUCTOR(wxFindReplaceDialog)
            WXJS_DECLARE_DESTRUCTOR(wxFindReplaceDialog)
