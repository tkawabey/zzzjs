    ...
    namespace gui
    {
        ...
        public:
            ...
            static void InitClass(JSContext* cx, 
                                  JSObject* obj, 
                                  JSObject* proto);
			WXJS_DECLARE_ADD_PROP(wxRadioButton)
			WXJS_DECLARE_DEL_PROP(wxRadioButton)
			WXJS_DECLARE_GET_PROP(wxRadioButton)
			WXJS_DECLARE_SET_PROP(wxRadioButton)
			WXJS_DECLARE_SET_STR_PROP(wxRadioButton)
			WXJS_DECLARE_CONSTRUCTOR(wxRadioButton)
			WXJS_DECLARE_DESTRUCTOR(wxRadioButton)
