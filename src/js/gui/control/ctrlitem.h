...
namespace zzzJs
{
  namespace gui
  {
    ...
    public:
			...
			WXJS_DECLARE_GET_PROP(wxControlWithItems)
			WXJS_DECLARE_SET_PROP(wxControlWithItems)
			WXJS_DECLARE_SET_STR_PROP(wxControlWithItems)
			WXJS_DECLARE_DESTRUCTOR(wxControlWithItems)
