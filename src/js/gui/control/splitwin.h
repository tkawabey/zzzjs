...
namespace zzzJs
{
    namespace gui
    {
        ...
        public:
			...
			WXJS_DECLARE_ADD_PROP(wxSplitterWindow)
			WXJS_DECLARE_DEL_PROP(wxSplitterWindow)
			WXJS_DECLARE_GET_PROP(wxSplitterWindow)
			WXJS_DECLARE_SET_PROP(wxSplitterWindow)
			WXJS_DECLARE_SET_STR_PROP(wxSplitterWindow)
			WXJS_DECLARE_CONSTRUCTOR(wxSplitterWindow)
            WXJS_DECLARE_DESTRUCTOR(wxSplitterWindow)
