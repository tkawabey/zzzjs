 ...
 * </class>
 */
WXJS_INIT_CLASS(TreeCtrl, "TreeCtrl", 2)
 ...
 *  </property>
 *  <property name="indent" type=WXJS_TYPE_NUMBER>
...
WXJS_BEGIN_GET_PROP(wxTreeCtrl, TreeCtrl)
{
    switch(id)
    {
    case P_COUNT:
    ...
    case P_ROOT_ITEM:
        vp.set( TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetRootItem())) );
        break;
    case P_SELECTION:
        vp.set( TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetSelection())) );
        break;
    case P_FIRST_VISIBLE:
        vp.set( TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetFirstVisibleItem())) );
        break;
    case P_EDIT_CONTROL:
      {
    ...
    case P_SELECTIONS:
        {
		  ...
		  size_t count = p->GetSelections(selections);
...
WXJS_BEGIN_SET_PROP(wxTreeCtrl, TreeCtrl)
{
    switch(id)
    {
    case P_INDENT:
...
WXJS_BEGIN_GET_SET_STR_PROP(wxTreeCtrl, TreeCtrl)
{
...
WXJS_BEGIN_ADD_PROP(wxTreeCtrl, TreeCtrl)
{
...
WXJS_BEGIN_DEL_PROP(wxTreeCtrl, TreeCtrl)
{
 ...
 *   </arg>
 *   <arg name="Style" type=WXJS_TYPE_NUMBER default="wxTreeCtrl.ICON">
...
WXJS_BEGIN_CONSTRUCTOR(wxTreeCtrl, TreeCtrl)
{
...
WXJS_BEGIN_DESTRUCTOR(wxTreeCtrl, TreeCtrl)
WXJS_END_DESTRUCTOR
...
JSBool TreeCtrl::create(JSContext *cx, unsigned argc, JS::Value *vp)
{
...
JSBool TreeCtrl::_innerCreate(JSContext *cx, JSObject *obj, unsigned argc, JS::Value *vp,jsval *rval)
{
 ...
 * </method>
 */
JSBool TreeCtrl::getItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        if ( id->IsOk() )
            *vp = TreeItem::CreateObject(cx, new wxTreeItemId(*id));
        else
            *vp = JSVAL_VOID;
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool TreeCtrl::getItemText(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::setItemText(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::getItemImage(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        *vp = ToJS(cx, p->GetItemImage(*id, (wxTreeItemIcon) which));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::setItemImage(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::getItemData(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::setItemData(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::getItemTextColour(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = Colour::CreateObject(cx, new wxColour(p->GetItemTextColour(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::setItemTextColour(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::getItemBackgroundColour(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = Colour::CreateObject(cx, new wxColour(p->GetItemBackgroundColour(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::setItemBackgroundColour(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::getItemFont(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = Font::CreateObject(cx, new wxFont(p->GetItemFont(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::setItemFont(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::setItemHasChildren(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::isBold(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::setItemBold(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::setItemDropHighlight(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::isVisible(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::isExpanded(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::isSelected(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::getChildrenCount(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = ToJS(cx, p->GetChildrenCount(*id, recursive));
        return JS_TRUE;
    }
    return JS_FALSE;
 ...
 * </method>
 */
JSBool TreeCtrl::getItemParent(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetItemParent(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
 ...
 * </method>
 */
JSBool TreeCtrl::getFirstChild(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
         ...
         && FromJS(cx, argv[1], cookie) )
    {
        ...
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetFirstChild(*id, newCookie)));
        return JS_TRUE;
    }
    return JS_FALSE;
 ...
 * </method>
 */
JSBool TreeCtrl::getNextChild(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
		wxTreeItemIdValue newCookie = (wxTreeItemIdValue) cookie;
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetNextChild(*id, newCookie)));
        return JS_TRUE;
    }
    return JS_FALSE;
 ...
 * </method>
 */
JSBool TreeCtrl::getPrevSibling(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetPrevSibling(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::getNextSibling(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetNextSibling(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::getPrevVisible(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetPrevVisible(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::getNextVisible(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( id != NULL )
    {
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->GetNextVisible(*id)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 *   </arg>
 *   <arg name="Image" type=WXJS_TYPE_NUMBER default="-1">
 *    Index of the image for normal items. The default is -1 which means don't use.
 *   </arg>
 *   <arg name="SelectedImage" type=WXJS_TYPE_NUMBER default="-1">
 ...
 * </method>
 */
JSBool TreeCtrl::addRoot(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    default:
        ...
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(p->AddRoot(text, image, selImage, data)));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::appendItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    default:
        ...
        *vp = TreeItemId::CreateObject(cx, new wxTreeItemId(newId));
        return JS_TRUE;
    }
    return JS_FALSE;
}
 ...
 * </method>
 */
JSBool TreeCtrl::prependItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::insertItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::deleteItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::deleteChildren(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::deleteAllItems(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::expand(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::collapse(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::collapseAndReset(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::toggle(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::unselect(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::unselectAll(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::selectItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::ensureVisible(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::scrollTo(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::editLabel(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::endEditLabel(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::sortChildren(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool TreeCtrl::hitTest(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        int flags;
        wxTreeItemId item = p->HitTest(*(apPoint.get()), flags);

        *vp = TreeHitTest::CreateObject(cx, new wxTreeHitTest(item, flags));
        return JS_TRUE;
    }
