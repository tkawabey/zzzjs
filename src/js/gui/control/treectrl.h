    ...
    namespace gui
    {
        ...
        public:
            ...
            static void InitClass(JSContext* cx, 
                                  JSObject* obj, 
                                  JSObject* proto);
			WXJS_DECLARE_ADD_PROP(wxTreeCtrl)
			WXJS_DECLARE_DEL_PROP(wxTreeCtrl)
			WXJS_DECLARE_GET_PROP(wxTreeCtrl)
			WXJS_DECLARE_SET_PROP(wxTreeCtrl)
			WXJS_DECLARE_SET_STR_PROP(wxTreeCtrl)
			WXJS_DECLARE_CONSTRUCTOR(wxTreeCtrl)
			WXJS_DECLARE_DESTRUCTOR(wxTreeCtrl)
