...
namespace zzzJs
{
    namespace gui
    {
        ...
        public:
			...
			WXJS_DECLARE_ADD_PROP(wxHtmlWindow)
			WXJS_DECLARE_DEL_PROP(wxHtmlWindow)
			WXJS_DECLARE_GET_PROP(wxHtmlWindow)
			WXJS_DECLARE_SET_PROP(wxHtmlWindow)
			WXJS_DECLARE_SET_STR_PROP(wxHtmlWindow)
			WXJS_DECLARE_CONSTRUCTOR(wxHtmlWindow)
            WXJS_DECLARE_DESTRUCTOR(wxHtmlWindow)
