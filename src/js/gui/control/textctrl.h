    ...
    namespace gui
    {
        ...
        public:
            static void InitClass(JSContext* cx, 
                                  JSObject* obj, 
                                  JSObject* proto);
			WXJS_DECLARE_ADD_PROP(wxTextCtrl)
			WXJS_DECLARE_DEL_PROP(wxTextCtrl)
			WXJS_DECLARE_GET_PROP(wxTextCtrl)
			WXJS_DECLARE_SET_PROP(wxTextCtrl)
			WXJS_DECLARE_SET_STR_PROP(wxTextCtrl)
			WXJS_DECLARE_CONSTRUCTOR(wxTextCtrl)
			WXJS_DECLARE_DESTRUCTOR(wxTextCtrl)
