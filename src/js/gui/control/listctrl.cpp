...
int wxCALLBACK ListCtrl::SortFn(wxIntPtr item1, wxIntPtr item2, wxIntPtr data)
{
    ...
    if ( JS_CallFunction(sortData->GetContext(), 
				MngInst::instance()->getGlobalJSObject( sortData->GetContext() ),
				//JS_GetGlobalObject(sortData->GetContext()),
				sortData->GetFn(), 3, argv, &rval) == JS_TRUE )
    {
        int rc;
 ...
 * </class>
 */
WXJS_INIT_CLASS(ListCtrl, "ListCtrl", 2)
 ...
 *  </property>
 *  <property name="countPerPage" type=WXJS_TYPE_NUMBER readonly="Y">
 ...
 *  </property>
 *  <property name="itemCount" type=WXJS_TYPE_NUMBER> 
 ...
 *  </property>
 *  <property name="selectedItemCount" type=WXJS_TYPE_NUMBER readonly="Y"> 
 *   Gets the number of selected items.
 *  </property>
 *  <property name="textColour" type="@wxColour">
 *   Gets/Sets the text colour of the list control.
 *  </property>
 *  <property name="topItem" type=WXJS_TYPE_NUMBER readonly="Y">
 *   Gets the index of the topmost visible item in report view.
 *  </property>
 *  <property name="windowStyleFlag" type=WXJS_TYPE_NUMBER> 
...
WXJS_BEGIN_GET_PROP(wxListCtrl, ListCtrl)
    switch (id)
    {
    case P_COLUMN_COUNT:
    ...
    case P_COUNT_PER_PAGE:
        ToJSVal(cx, vp,  p->GetCountPerPage());
        break;
    case P_EDIT_CONTROL:
        #ifdef __WXMSW__
        	vp.set( TextCtrl::CreateObject(cx, p->GetEditControl(), obj) );
        #endif
        break;
    case P_ITEM_COUNT:
        ToJSVal(cx, vp,  p->GetColumnCount());
    ...
    case P_SELECTED_ITEM_COUNT:
        ToJSVal(cx, vp,  p->GetSelectedItemCount());
        break;
    case P_TEXT_COLOUR:
        vp.set( Colour::CreateObject(cx, new wxColour(p->GetTextColour())) );
        break;
    case P_TOP_ITEM:
        ToJSVal(cx, vp,  p->GetTopItem());
        break;
    case P_WINDOW_STYLE:
        ToJSVal(cx, vp,  p->GetWindowStyleFlag());
        break;
    case P_IS_VIRTUAL:
        ToJSVal(cx, vp,  p->IsVirtual());
        break;
    }
    return true;
WXJS_END_GET_PROP
...
WXJS_BEGIN_SET_PROP(wxListCtrl, ListCtrl)
    switch (id)
    {
    case P_ITEM_COUNT:
        {
...
WXJS_BEGIN_GET_SET_STR_PROP(wxListCtrl, ListCtrl)
	Control::SetStringProperty(p, cx,  obj, propertyName, vp);
	return true;
ZZZJS_END_GET_SET_STR_PROP

WXJS_BEGIN_ADD_PROP(wxListCtrl, ListCtrl)
...
WXJS_BEGIN_DEL_PROP(wxListCtrl, ListCtrl)
 ...
 *   </arg>
 *   <arg name="Style" type=WXJS_TYPE_NUMBER default="wxListCtrl.ICON">
...
WXJS_BEGIN_CONSTRUCTOR(wxListCtrl, ListCtrl)
...
WXJS_BEGIN_DESTRUCTOR(wxListCtrl, ListCtrl)
WXJS_END_DESTRUCTOR
 ...
 * </method>
 */
JSBool ListCtrl::create(JSContext *cx, unsigned argc, JS::Value *vp)
{
...
JSBool ListCtrl::_innerCreate(JSContext *cx, JSObject *obj, unsigned argc, JS::Value *vp,jsval *rval)
{
 ...
 *   <arg name="Col" type=WXJS_TYPE_NUMBER>
 *    The column number
 *   </arg>
 *   <arg name="Item" type=WXJS_TYPE_NUMBER>
 *    The item index
 *   </arg>
 *  </function>
 *  <function returns="Boolean">
 ...
 * </method>
 */
JSBool ListCtrl::getColumn(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( FromJS(cx, argv[0], col) )
    {
        if ( ListItem::HasPrototype(cx, argv[1]) )
        {
            ...
            *vp = ToJS(cx, p->GetColumn(col, *item));
        }
        else
        {
            int idx;
            if ( FromJS(cx, argv[1], idx) )
            {
                ...
                {
                    *vp = ListItem::CreateObject(cx, item, obj);
                }
                else
                {
                    delete item;
 ...
 * </method>
 */
JSBool ListCtrl::setColumn(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::getColumnWidth(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( FromJS(cx, argv[0], col) )
    {
        *vp =  ToJS(cx, p->GetColumnWidth(col));
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::setColumnWidth(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    *vp =  ToJS(cx, p->SetColumnWidth(col, width));
    return JS_TRUE;
}
 ...
 * </method>
 */
JSBool ListCtrl::getItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *   </arg>
 *   <arg name="ImageId" type=WXJS_TYPE_NUMBER default="-1">
 ...
 * </method>
 */
JSBool ListCtrl::setItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    else
    {
        ...
        {
            *vp =  ToJS(cx, p->SetItem(idx, col, label, imageId));
        }
        else
            return JS_FALSE;
    }
 ...
 *    The item index
 *   </arg>
 *   <arg name="StateMask" type=WXJS_TYPE_NUMBER>
 ...
 * </method>
 */
JSBool ListCtrl::getItemState(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        *vp =  ToJS(cx, p->GetItemState(item, stateMask));
        return JS_TRUE;
    }
 ...
 *    The item index.
 *   </arg>
 *   <arg name="State" type=WXJS_TYPE_NUMBER>
 *    The new state.
 *   </arg>
 *   <arg name="StateMask" type=WXJS_TYPE_NUMBER>
 *    Indicates which state flags are valid.
 ...
 * </method>
 */
JSBool ListCtrl::setItemState(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        *vp =  ToJS(cx, p->SetItemState(item, state, stateMask));
        return JS_TRUE;
    }
 ...
 *   </arg>
 *   <arg name="SelImage" type=WXJS_TYPE_NUMBER>
 ...
 * </method>
 */
JSBool ListCtrl::setItemImage(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        *vp =  ToJS(cx, p->SetItemImage(item, image, selImage));
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::getItemText(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::setItemText(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::getItemData(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::setItemData(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *    The item index.
 *   </arg>
 *   <arg name="Code" type=WXJS_TYPE_NUMBER>
 ...
 * </method>
 */
JSBool ListCtrl::getItemRect(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::getItemPosition(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( FromJS(cx, argv[0], item) )
    {
        ...
        {
          *vp =  zzzJs::ext::CreatePoint(cx, pt);
        }
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::setItemPosition(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
	...
	int argIndex = 0;
    long item;
    if ( FromJS(cx, argv[argIndex], item) )
    {
		argIndex++;
		zzzJsPtr<wxPoint> apPoint(NULL, &wxDefaultPosition);
		...
		if( ZZZJS_ARG_GET_AP(apPoint, zzzJs::ext::Point) == true ) {
            ...
            *vp =  ToJS(cx, p->SetItemPosition(item, *(apPoint.get())));
            return JS_TRUE;
		}
    }
 ...
 * </method>
 */
JSBool ListCtrl::getItemSpacing(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    *vp =  Size::CreateObject(cx, new wxSize(p->GetItemSpacing()));
#else
    bool isSmall;

    if ( FromJS(cx, argv[0], isSmall) )
    {
        *vp =  ToJS(cx, p->GetItemSpacing(isSmall));
    }
#endif
    return JS_TRUE;
}
 ...
 * </method>
 */
JSBool ListCtrl::setSingleStyle(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *   </arg>
 *   <arg name="Geometry" type=WXJS_TYPE_NUMBER default="wxListNext.ALL">
 *    Search direction. Use one of the constants defined in @wxListCtrl#wxListNext.
 *   </arg>
 *   <arg name="State" type=WXJS_TYPE_NUMBER default="wxListState.DONTCARE">
 ...
 * </method>
 */
JSBool ListCtrl::getNextItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    default:
        ...
        *vp =  ToJS(cx, p->GetNextItem(item, next, state));
    }
 ...
 * </method>
 */
JSBool ListCtrl::getImageList(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::setImageList(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::refreshItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::refreshItems(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * <method name="arrange">
 *  <function returns="Boolean">
 *   <arg name="Align" type=WXJS_TYPE_NUMBER default="wxListAlign.DEFAULT" />
 *  </function>
 *  <desc>
 ...
 * </method>
 */
JSBool ListCtrl::arrange(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::deleteItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::deleteAllItems(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::deleteColumn(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::deleteAllColumns(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 * </method>
 */
JSBool ListCtrl::clearAll(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *    A column index
 *   </arg>
 *   <arg name="Heading" type=WXJS_TYPE_STRING>
 *    The name for the header.
 *   </arg>
 *   <arg name="Format" type=WXJS_TYPE_NUMBER default="wxListFormat.LEFT">
 ...
 * </method>
 */
JSBool ListCtrl::insertColumn(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        wxListItem *item = ListItem::GetPrivate(cx, argv[1], false);
        *vp =  ToJS(cx, p->InsertColumn(col, *item));
    }
    else
    {
        wxString header;
        ...
        *vp =  ToJS(cx, p->InsertColumn(col, header, format, width));
    }
 ...
 *    Label of the item
 *   </arg>
 *   <arg name="ImageIdx" type=WXJS_TYPE_NUMBER default="-1">
 ...
 *    The item index.
 *   </arg>
 *   <arg name="ImageIdx" type=WXJS_TYPE_NUMBER>
 *    The index of the image in the associated imagelist.
 *   </arg>
 *  </function>
 *  <desc>
 ...
 * </method>
 */
JSBool ListCtrl::insertItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    else if ( argc > 1 )
    {
        ...
        if ( FromJS(cx, argv[0], item) )
        {
            ...
            if ( JSVAL_IS_INT(argv[1]) )
            {
                ...
                *vp =  ToJS(cx, p->InsertItem(item, imageIdx));
                return JS_TRUE;
            }
            else
            {
                ...
                if ( argc > 2 )
                {
                    ...
                    {
                        *vp =  ToJS(cx, p->InsertItem(item, label, imageIdx));
                        return JS_TRUE;
                    }
                }
                else
                {
                    *vp =  ToJS(cx, p->InsertItem(item, label));
                    return JS_TRUE;
                }
            }
        }
 ...
 * </method>
 */
JSBool ListCtrl::editLabel(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( FromJS(cx, argv[0], item) )
    {
   		p->EditLabel(item);
    	#ifdef __WXMSW__
	        *vp =  TextCtrl::CreateObject(cx, p->GetEditControl());
	    #endif
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::endEditLabel(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( p == NULL )
	    ...
	    {
	        *vp =  ToJS(cx, p->EndEditLabel(cancel));
	        return JS_TRUE;
	    }
	#endif
 ...
 * </method>
 */
JSBool ListCtrl::ensureVisible(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( FromJS(cx, argv[0], item) )
    {
        *vp =  ToJS(cx, p->EnsureVisible(item));
        return JS_TRUE;
    }
 ...
 *    The item to start the search or -1 to start from the beginning.
 *   </arg>
 *   <arg name="Data" type=WXJS_TYPE_NUMBER>
 ...
 *   </arg>
 *   <arg name="Direction" type=WXJS_TYPE_NUMBER>
 ...
 * </method>
 */
JSBool ListCtrl::findItem(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    if ( FromJS(cx, argv[argIndex], item) )
    {
        ...
        if ( ZZZJS_ARG_GET_AP(apPoint, zzzJs::ext::Point) == true  )
        {
            ...
            {
                *vp =  ToJS(cx, p->FindItem(item, *(apPoint.get()), direction));
                return JS_TRUE;
            }
        }
        else if ( JSVAL_IS_INT(argv[1]) )
        {
            ...
            *vp =  ToJS(cx, p->FindItem(item, data));
            return JS_TRUE;
        }
        else
        {
            ...
            *vp =  ToJS(cx, p->FindItem(item, str, partial));
            return JS_TRUE;
        }
    }
 ...
 * </method>
 */
JSBool ListCtrl::hitTest(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
    ...
    {
        int flags;
        long item = p->HitTest(*(apPoint.get()), flags);

        *vp =  ListHitTest::CreateObject(cx, new wxListHitTest(item, flags));
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::scrollList(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
 ...
 *   </arg>
 *   <arg name="Data" type=WXJS_TYPE_NUMBER default="0">
 ...
 * </method>
 */
JSBool ListCtrl::sortItems(JSContext *cx, unsigned argc, JS::Value *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	JS::CallArgs argv = CallArgsFromVp(argc, vp);
