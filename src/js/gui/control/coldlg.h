...
namespace zzzJs
{
	namespace gui
	{
		...
		{
		public:
			WXJS_DECLARE_GET_PROP(wxColourDialog)
			WXJS_DECLARE_SET_STR_PROP(wxColourDialog)
			WXJS_DECLARE_CONSTRUCTOR(wxColourDialog)
			//static void Destruct(JSContext *cx, wxColourDialog *p);
			WXJS_DECLARE_DESTRUCTOR(wxColourDialog)
