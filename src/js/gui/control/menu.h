...
namespace zzzJs
{
    namespace gui
    {
        ...
        public:
			...
			WXJS_DECLARE_GET_PROP(wxMenu)
			WXJS_DECLARE_SET_PROP(wxMenu)
			WXJS_DECLARE_CONSTRUCTOR(wxMenu)
            WXJS_DECLARE_DESTRUCTOR(wxMenu)
...
//	        static void Destruct(JSContext *cx, wxMenu *p);
	        ...
	        WXJS_DECLARE_METHOD(append_checkItem)
			WXJS_DECLARE_METHOD(append_radioItem)
			WXJS_DECLARE_METHOD(append_subMenu)
