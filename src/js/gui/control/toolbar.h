    ...
    namespace gui
    {
      ...
      public:
        ...
        virtual bool DoDeleteTool(size_t pos, wxToolBarToolBase *tool);
			...
			WXJS_DECLARE_GET_PROP(wxToolBar)
			WXJS_DECLARE_SET_PROP(wxToolBar)
			WXJS_DECLARE_SET_STR_PROP(wxToolBar)
			WXJS_DECLARE_CONSTRUCTOR(wxToolBar)
            WXJS_DECLARE_DESTRUCTOR(wxToolBar)
